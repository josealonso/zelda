...
interface FinalMarketplaceV2Interface extends ethers.utils.Interface {
  functions: {
...
export class FinalMarketplaceV2 extends BaseContract {
  ...
  interface: FinalMarketplaceV2Interface;
